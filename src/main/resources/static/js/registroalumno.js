var rep1encontrado=0;
var rep2encontrado=0;
...
$("#botonBuscRep2").click(function () {
    $.ajax({
        data: { tdoc: $('select[name=tipoDocRep2]').val(), ndoc: $('input:text[name=numDocRep2]').val() },
        url: "http://localhost:8080/app/consultarepresentante",
        dataType: 'json', //tipo de datos retornados
        type: "GET"
    }).done(function (data) {
...
$("#guardarAlumno").click(function () {
    ...
    //alert(validarCampoNombre($("#primNombAl").val()));

    dirPppalAl = $("#textoDirPpalAl").val() + " " + "ESTADO: " + $("#estadodirppalest").val() + " " + "MUNICIPIO: " + $("#municipiodirppalest").val()
        + " " + "CIUDAD: " + $("#ciudaddirppalest").val() + " " + "PARROQUIA: " + $("#parroquiadirppalest").val() + " " + "COD POSTAL: " + $("#codpostaldirppalest").val();

    if($("#textoDirSecAl").val()==""){
        dirSecAl=dirPppalAl;
    }else{
        dirSecAl = $("#textoDirSecAl").val() + " " + "ESTADO: " + $("#estadodirsecest").val() + " " + "MUNICIPIO: " + $("#municipiodirsecest").val()
        + " " + "CIUDAD: " + $("#ciudaddirsecest").val() + " " + "PARROQUIA: " + $("#parroquiadirsecest").val() + " " + "COD POSTAL: " + $("#codpostaldirsecest").val();
    }

    tlfPpalAl = $("#codoperadorappalest").val() + "-" + $("#textoTlfPpalAl").val();
        
    if($("#codoperadorappalest").val()==null && $("#textoTlfPpalAl").val()=="" ){
        tlfSecAl=tlfPpalAl;
    }else{
    ...
    if (rep1encontrado==1) {
        ...
        tlfPpalRpr1=$("#txtCodoperadorappalrep1").val()+"-"+$("#txtTextoTlfPpalRpr1").val();
        tlfSecRpr1=$("#txtCodoperadorasecrep1").val()+"-"+$("#txtTextoTlfSecRpr1").val();

    }else{
        sexoRpr1 = $("#sexoRpr1").val();
        edoCivRpr1=$("#edoCivRpr1").val();
        parentescoRpr1=$("#parentescoRpr1").val();
        dirPpalRpr1 = $("#textoDirPpalRpr1").val() + " " + "ESTADO: " + $("#estadodirppalrep1").val() + " " + "MUNICIPIO: " + $("#municipiodirppalrep1").val()
        + " " + "CIUDAD: " + $("#ciudaddirppalrep1").val() + " " + "PARROQUIA: " + $("#parroquiadirppalrep1").val() + " " + "COD POSTAL: " + $("#codpostaldirppalrep1").val();
        tlfPpalRpr1 = $("#codoperadorappalrep1").val() + "-" + $("#textoTlfPpalRpr1").val();
         
        if($("#textoDirSecRpr1").val()==""){    
            dirSecRpr1=dirPpalRpr1;
        }else{
            dirSecRpr1 = $("#textoDirSecRpr1").val() + " " + "ESTADO: " + $("#estadodirsecrep1").val() + " " + "MUNICIPIO: " + $("#municipiodirsecrep1").val()
            + " " + "CIUDAD: " + $("#ciudaddirsecrep1").val() + " " + "PARROQUIA: " + $("#parroquiadirsecrep1").val() + " " + "COD POSTAL: " + $("#codpostaldirsecrep1").val();
        }
        
        if($("#codoperadorasecrep1").val()==null && $("#textoTlfSecRpr1").val()==""){
            tlfSecRpr1=tlfPpalRpr1;
        }else{
            tlfSecRpr1 = $("#codoperadorasecrep1").val() + "-" + $("#textoTlfSecRpr1").val();
        }
    ...
    if ($("#chkRepresentante2").prop("checked")) {
        ...
        if (rep2encontrado==1) {
            ...
            tlfPpalRpr2=$("#txtCodoperadorappalrep2").val()+"-"+$("#txtTextoTlfPpalRpr2").val();
            tlfSecRpr2=$("#txtCodoperadorasecrep2").val()+"-"+$("#txtTextoTlfSecRpr2").val();
    
        }else{
            sexoRpr2 = $("#sexoRpr2").val();
            edoCivRpr2=$("#edoCivRpr2").val();
            parentescoRpr2=$("#parentescoRpr2").val();
            dirPpalRpr2 = $("#textoDirPpalRpr2").val() + " " + "ESTADO: " + $("#estadodirppalrep2").val() + " " + "MUNICIPIO: " + $("#municipiodirppalrep2").val()
            + " " + "CIUDAD: " + $("#ciudaddirppalrep2").val() + " " + "PARROQUIA: " + $("#parroquiadirppalrep2").val() + " " + "COD POSTAL: " + $("#codpostaldirppalrep2").val();
            tlfPpalRpr2 = $("#codoperadorappalrep2").val() + "-" + $("#textoTlfPpalRpr2").val();
           
            if($("#textoDirSecRpr2").val()==""){    
                dirSecRpr2=dirPpalRpr2;
            }else{
                dirSecRpr2 = $("#textoDirSecRpr2").val() + " " + "ESTADO: " + $("#estadodirsecrep2").val() + " " + "MUNICIPIO: " + $("#municipiodirsecrep2").val()
                + " " + "CIUDAD: " + $("#ciudaddirsecrep2").val() + " " + "PARROQUIA: " + $("#parroquiadirsecrep2").val() + " " + "COD POSTAL: " + $("#codpostaldirsecrep2").val();
            }
    
            if($("#codoperadorasecrep2").val()==null && $("#textoTlfSecRpr2").val()==""){
                tlfSecRpr2=tlfPpalRpr2;
            }else{
                tlfSecRpr2 = $("#codoperadorasecrep2").val() + "-" + $("#textoTlfSecRpr2").val();
            }
        }
    }
